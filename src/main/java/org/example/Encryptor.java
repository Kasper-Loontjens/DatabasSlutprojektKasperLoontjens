...
public abstract class Encryptor {
    public static String[] EncryptPassword(String password){
        ...
        try {
            ...
            String[] hashedPassSalt = new String[]{(byteArrayToHexString(hashPass) + byteArrayToHexString(salt)), byteArrayToHexString(hashPass),byteArrayToHexString(salt)};
//            System.out.println(hashedPassSalt[0]+ " \n" +
//                    hashedPassSalt[1]+ " \n" +
//                    hashedPassSalt[2]+ " \n"); // testing testing

            return hashedPassSalt;
